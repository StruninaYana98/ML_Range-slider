class NumericInput{
    ...
    createNumericInput(header,value){
       ...
       buttonsInputWrapper.className ="buttonsInputWrapper"
         ...
         plusButton.onclick=(e)=>{numericInput.value++;let event = new Event('change') ; numericInput.dispatchEvent(event)}
        ...
        minusButton.onclick = ()=>{numericInput.value--;let event = new Event('change') ; numericInput.dispatchEvent(event)}
